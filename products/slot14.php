<?php
    ...
    $stmt5 = "SELECT * FROM shopping  where id ='9' ORDER BY id DESC;";
    $stmt6 = "SELECT * FROM shopping  where id ='10' ORDER BY id DESC;";
    $stmt7 = "SELECT * FROM shopping  where id ='11' ORDER BY id DESC;";
    $stmt8 = "SELECT * FROM shopping  where id ='12' ORDER BY id DESC;";
    $stmt9 = "SELECT * FROM shopping  where id ='13' ORDER BY id DESC;";
    $stmt10 = "SELECT * FROM shopping  where id ='14' ORDER BY id DESC;";
    $stmt11= "SELECT * FROM shopping  where id ='15' ORDER BY id DESC;";
    $stmt12 = "SELECT * FROM shopping  where id ='16' ORDER BY id DESC;";
    $stmt13 = "SELECT * FROM shopping  where id ='17' ORDER BY id DESC;";
    $stmt14 = "SELECT * FROM shopping  where id ='18' ORDER BY id DESC;";
    $stmt15= "SELECT * FROM shopping  where id ='19' ORDER BY id DESC;";
    $stmt16 = "SELECT * FROM shopping  where id ='20' ORDER BY id DESC;";
...
<head>
    ...
    <link rel="shortcut icon" href="../images/Sellcia logo.jpg" type="image/x-icon">
...
<body>
    <header>
        <nav class="nav1">
            <li><a><img src="../images/vSellcia logo.jpg" alt=""></a></li>
    ...
    <div class="container-grid">
        <div id="grid">
            <div class="slot12">
                    <div class="img" style="height:-200px;"><img src="http://localhost:8888/vela/uploads/<?php echo $rows14['Image'];?>" alt="" style="max-height:250px;"></div>
