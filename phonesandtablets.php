<?php
    ...
    $stmt1 = "SELECT * FROM shopping  where id ='27' ORDER BY id DESC;";
    $stmt2 = "SELECT * FROM shopping  where id ='28' ORDER BY id DESC;";
    $stmt3 = "SELECT * FROM shopping  where id ='29' ORDER BY id DESC;";
    $stmt4 = "SELECT * FROM shopping  where id ='30' ORDER BY id DESC;";
    $stmt5 = "SELECT * FROM shopping  where id ='31' ORDER BY id DESC;";
    $stmt6 = "SELECT * FROM shopping  where id ='32' ORDER BY id DESC;";
    $stmt7 = "SELECT * FROM shopping  where id ='33' ORDER BY id DESC;";
    $stmt8 = "SELECT * FROM shopping  where id ='34' ORDER BY id DESC;";
    ...
    $stmt13 = "SELECT * FROM shopping  where id ='39' ORDER BY id DESC;";
    $stmt14 = "SELECT * FROM shopping  where id ='40' ORDER BY id DESC;";
    $stmt15= "SELECT * FROM shopping  where id ='41' ORDER BY id DESC;";
    $stmt16 = "SELECT * FROM shopping  where id ='43' ORDER BY id DESC;";
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
						...
						<p class="mb-4">Sellcia Express.</p>
						<ul class="f-address">
							<li>
								<div class="row">
						...
						<ul class="f-address">
							<li>
								<div class="row">
									...
									<div class="col-10">
										<p class="mb-0"><a href="#">@Alitah </a> HTML Version Out Now</p>
							...
							<li>
								<div class="row">
									<div class="col-1"><i class="fab fa-twitter"></i></div>
									<div class="col-10">
										<p class="mb-0"><a href="#">@James </a> HTML Version Out Now</p>
										<label>10 Mins Ago</label>
									</div>
								</div>
							</li>
