...
<head>
    ...
    <link rel="shortcut icon" href="Sellcia logo.jpg" type="image/x-icon">
    <!-- Font Icon -->
...
<body style="height:600px;">
    <div class="logo">
    <img src="images/Sellcia logo.jpg" style="max-width:100px; margin-top:-120px; margin-left:-10px;" alt="">
    </div>
    <?php
      if(empty($_GET)) {}
